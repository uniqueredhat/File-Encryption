...
public class Decrypt extends javax.swing.JFrame {
   ...
   boolean sucess = Decryption.Decrypt(fileName,filePathWithFileName,fileLocation,passWord,extension);
   ...
   Mine mine = new Mine();
    ...
    private static String decreaseAscii(String extension){
    char c[]=extension.toCharArray();
    String decreasedAscii="";
        for(int i =0;i<extension.length();i++){
        decreasedAscii += (char)((int)c[i]-1);
        }
        
        return decreasedAscii;
    }
    ...
    extension = decreaseAscii(extension);
        return extension;
}
